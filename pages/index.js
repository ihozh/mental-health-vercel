...
export default function Home() {
  ...
  if (loading) return <><Nav /><div style={{ padding: 24, paddingTop: 64 }}>Loading...</div></>;
  if (error) return (
    <><Nav /><div style={{ color: 'red', padding: 24, paddingTop: 64 }}>
  ...
  if (!stats || !stats.postsPerHour) return <><Nav /><div style={{ padding: 24, paddingTop: 64 }}>No data available.</div></>;
